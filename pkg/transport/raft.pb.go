...
// 	protoc        v7.35.0--rc1
// source: pkg/transport/raft.proto
...
func (x *RequestVoteRequest) Reset() {
	*x = RequestVoteRequest{}
	mi := &file_pkg_transport_raft_proto_msgTypes[0]
...
func (*RequestVoteRequest) Descriptor() ([]byte, []int) {
	return file_pkg_transport_raft_proto_rawDescGZIP(), []int{0}
}
...
func (x *RequestVoteResponse) Reset() {
	*x = RequestVoteResponse{}
	mi := &file_pkg_transport_raft_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestVoteResponse) Descriptor() ([]byte, []int) {
	return file_pkg_transport_raft_proto_rawDescGZIP(), []int{1}
}
...
func (x *AppendEntriesRequest) Reset() {
	*x = AppendEntriesRequest{}
	mi := &file_pkg_transport_raft_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEntriesRequest) Descriptor() ([]byte, []int) {
	return file_pkg_transport_raft_proto_rawDescGZIP(), []int{2}
}
...
func (x *AppendEntriesResponse) Reset() {
	*x = AppendEntriesResponse{}
	mi := &file_pkg_transport_raft_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEntriesResponse) Descriptor() ([]byte, []int) {
	return file_pkg_transport_raft_proto_rawDescGZIP(), []int{3}
}
...
var File_pkg_transport_raft_proto protoreflect.FileDescriptor
...
var (
	file_pkg_transport_raft_proto_rawDescOnce sync.Once
	file_pkg_transport_raft_proto_rawDescData []byte
)

func file_pkg_transport_raft_proto_rawDescGZIP() []byte {
	file_pkg_transport_raft_proto_rawDescOnce.Do(func() {
		file_pkg_transport_raft_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_transport_raft_proto_rawDesc), len(file_pkg_transport_raft_proto_rawDesc)))
	})
	return file_pkg_transport_raft_proto_rawDescData
}

var file_pkg_transport_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_transport_raft_proto_goTypes = []any{
	(*RequestVoteRequest)(nil),    // 0: transport.RequestVoteRequest
	(*RequestVoteResponse)(nil),   // 1: transport.RequestVoteResponse
	(*AppendEntriesRequest)(nil),  // 2: transport.AppendEntriesRequest
	(*AppendEntriesResponse)(nil), // 3: transport.AppendEntriesResponse
}
var file_pkg_transport_raft_proto_depIdxs = []int32{
	0, // 0: transport.Raft.RequestVote:input_type -> transport.RequestVoteRequest
	2, // 1: transport.Raft.AppendEntries:input_type -> transport.AppendEntriesRequest
	1, // 2: transport.Raft.RequestVote:output_type -> transport.RequestVoteResponse
	3, // 3: transport.Raft.AppendEntries:output_type -> transport.AppendEntriesResponse
...
func init() { file_pkg_transport_raft_proto_init() }
func file_pkg_transport_raft_proto_init() {
	if File_pkg_transport_raft_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_transport_raft_proto_rawDesc), len(file_pkg_transport_raft_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_transport_raft_proto_goTypes,
		DependencyIndexes: file_pkg_transport_raft_proto_depIdxs,
		MessageInfos:      file_pkg_transport_raft_proto_msgTypes,
	}.Build()
	File_pkg_transport_raft_proto = out.File
	file_pkg_transport_raft_proto_goTypes = nil
	file_pkg_transport_raft_proto_depIdxs = nil
}
